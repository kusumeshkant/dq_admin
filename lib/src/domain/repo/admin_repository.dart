...
abstract class AdminRepository {
  ...
  Future<ProductEntity> createProduct({required String storeId, required String barcode, required String name, String? description, required double price, required int stock});
  Future<ProductEntity> updateProduct({required String id, String? name, String? description, double? price, int? stock});
