...
class FlaggedIssueModel extends FlaggedIssueEntity {
  ...
  factory FlaggedIssueModel.fromJson(Map<String, dynamic> json) => FlaggedIssueModel(
...
class OrderModel extends OrderEntity {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) => OrderModel(
        ...
        flaggedIssue: json['flaggedIssue'] != null
            ? FlaggedIssueModel.fromJson(json['flaggedIssue'] as Map<String, dynamic>)
            : null,
      );
}
