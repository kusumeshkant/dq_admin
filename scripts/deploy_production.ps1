...
# production bundle for dq_admin (app.dqstore.in).
#
...
# the correct new bundle immediately - but the custom domain (app.dqstore.in)
...
param(
    [string]$ProjectName = "dq-admin",
    [string]$Domain      = "app.dqstore.in",
